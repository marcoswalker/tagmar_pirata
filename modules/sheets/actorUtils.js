...
export function _attKarmaMax(data, updatePers) {
    ...
    if (updatePers.hasOwnProperty('system.atributos.AUR')) aura = updatePers['system.atributos.AUR'];
    let profissao = data.document.items.find(e => e.type == "Profissao");
    if (profissao) {
        if (profissao.system.fadiga == "fadiga") {
            aura = data.document.system.atributos.FIS;
            if (updatePers.hasOwnProperty('system.atributos.FIS')) aura = updatePers['system.atributos.FIS'];
        }
    }
